...
const images: { src: string; alt: string; cat: Category; span?: string }[] = [
  { src: 'https://chillandcheer.pixieset.com/share/6a3be874a2e28/?pid=19116135219&id=0&h=Mjg0MjU3ODAxMw?auto=compress&cs=tinysrgb&w=800&h=800&fit=crop', alt: 'Wedding slush bar setup', cat: 'Weddings', span: 'sm:col-span-2 sm:row-span-2' },
